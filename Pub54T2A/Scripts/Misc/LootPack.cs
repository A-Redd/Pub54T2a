...
namespace Server
{
	public class LootPack
	{
		...
		{
			new LootPackItem(typeof(BaseJewel), 2), new LootPackItem(typeof(BaseArmor), 17),
			new LootPackItem(typeof(BaseWeapon), 14), new LootPackItem(typeof(BaseRanged), 5),
		...
		public static readonly LootPack OldPoor =
                ...
                new[]
                {
                  ...
                  new LootPackEntry( false, OldMagicItems,      1.00, 1, 1, 5, 55 ),
                  new LootPackEntry( false, OldMagicItems,      1.50, 1, 1, 10, 75 ),
                  new LootPackEntry( false, OldMagicItems,      0.40, 1, 1, 20, 100 ),
                  new LootPackEntry( false, OldMagicItems,      0.35, 1, 1, 30, 100 ),
                  new LootPackEntry( false, OldMagicItems,      0.30, 1, 1, 50, 100 ),
                });
		...
		public static readonly LootPack OldMeager =
			new LootPack(
				new[]
				{
                    ...
                    new LootPackEntry( false, OldMagicItems,      1.00, 1, 1, 5, 55 ),
                    new LootPackEntry( false, OldMagicItems,      1.00, 1, 1, 10, 75 ),
                    new LootPackEntry( false, OldMagicItems,      0.50, 1, 1, 5, 100 ),
                    new LootPackEntry( false, OldMagicItems,      0.40, 1, 1, 10, 100 ),
                    new LootPackEntry( false, OldMagicItems,      0.35, 1, 1, 20, 100 ),
		...
		public static readonly LootPack OldAverage =
			new LootPack(
				new[]
				{
                    ...
                    new LootPackEntry( false, OldMagicItems,      2.50, 1, 1, 5, 55 ),
                    new LootPackEntry( false, OldMagicItems,      2.50, 1, 1, 10, 75 ),
                    new LootPackEntry( false, OldMagicItems,      1.00, 1, 1, 5, 100 ),
                    new LootPackEntry( false, OldMagicItems,      0.50, 1, 1, 20, 100 ),
                    new LootPackEntry( false, OldMagicItems,      0.35, 1, 1, 30, 100 ),
                });
		...
		public static readonly LootPack OldRich =
			new LootPack(
				new[]
				{
                    ...
                    new LootPackEntry( false, OldMagicItems,      3.00, 1, 1, 5, 55 ),
                    new LootPackEntry( false, OldMagicItems,      2.50, 1, 1, 10, 75 ),
                    new LootPackEntry( false, OldMagicItems,      2.00, 1, 1, 5, 100 ),
                    new LootPackEntry( false, OldMagicItems,      1.50, 1, 1, 20, 100 ),
                    new LootPackEntry( false, OldMagicItems,      1.00, 1, 1, 30, 100 ),
                });
		...
		public static readonly LootPack OldFilthyRich =
			new LootPack(
				new[]
				{
                    ...
                    new LootPackEntry( false, OldMagicItems,      5.00, 1, 1, 5, 55 ),
                    new LootPackEntry( false, OldMagicItems,      4.50, 1, 1, 10, 75 ),
                    new LootPackEntry( false, OldMagicItems,      3.00, 1, 1, 5, 100 ),
                    new LootPackEntry( false, OldMagicItems,      2.50, 1, 1, 20, 100 ),
                    new LootPackEntry( false, OldMagicItems,      2.00, 1, 1, 30, 100 ),
                });
		...
		public static readonly LootPack OldUltraRich =
			new LootPack(
				new[]
				{
                    ...
                    new LootPackEntry( false, OldMagicItems,      4.20, 1, 1, 20, 100 ),
                    new LootPackEntry( false, OldMagicItems,      3.25, 1, 1, 30, 100 ),
                    new LootPackEntry( false, OldMagicItems,      2.50, 1, 1, 50, 100 ),
                    new LootPackEntry( false, OldMagicItems,      1.25, 1, 1, 60, 100 ),
                });
		...
		public static readonly LootPack OldSuperBoss =
			new LootPack(
                ...
                new LootPackEntry( false, OldMagicItems,      7.50 *2, 1, 1, 10, 75 ),
                new LootPackEntry( false, OldMagicItems,      5.25 *2, 1, 1, 20, 100 ),
                new LootPackEntry( false, OldMagicItems,      5.25 *2, 1, 1, 30, 100 ),
                new LootPackEntry( false, OldMagicItems,      4.50 *2, 1, 1, 50, 100 ),
                new LootPackEntry( false, OldMagicItems,      4.50 *2, 1, 1, 60, 100 ),
                new LootPackEntry( false, OldMagicItems,      2.50 *2, 1, 1, 80, 100 ),
	...
	public class LootPackEntry
	{
        ...
        private int GetRandomOldDamBonus()
        {
            int rnd = Utility.RandomMinMax(m_MinIntensity, m_MaxIntensity);
				...
				if (item is BaseWeapon || item is BaseArmor || item is BaseJewel || item is BaseHat)
				{
					...
					else // not aos
					{
						if (item is BaseWeapon)
						{
							...
							{
                                weapon.Slayer = SlayerGroup.GetLootSlayerType(from.GetType());//weapon.Slayer = SlayerName.Silver;
                            }
