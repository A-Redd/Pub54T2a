...
namespace Server
{
    public static class MondainsLegacy
    {
        ...
        public static void GiveArtifactTo(Mobile m)
        {
            ...
            {
                m.SendAsciiMessage("An item has been placed in your backpack."); // An item has been placed in your backpack.
                m.SendAsciiMessage("For your valor in combating the fallen beast, a special artifact has been bestowed on you."); // For your valor in combating the fallen beast, a special artifact has been bestowed on you.
            }
        ...
        public static bool CheckML(Mobile from, bool message)
        {
            ...
            if (message)
                from.SendAsciiMessage("You must upgrade to Mondain's Legacy in order to use that item."); // You must upgrade to Mondain's Legacy in order to use that item. 
