    ...
    public class NotorietyHandlers
    {
        ...
        public static bool Mobile_AllowHarmful(Mobile from, Mobile target)
        {
            ...
            if (target is Gregorio)
            {
                ...
                from.SendAsciiMessage("You are not allowed to damage this NPC unless your on the Guilty Quest"); // You are not allowed to damage this NPC unless your on the Guilty Quest
                return false;
            }
            #endregion
