        ...
        */
        ...
        private class UnBlessEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                if (pack != null)
                {
                    ...
                    m_From.SendAsciiMessage("a personal bless deed has been placed in your backpack"); // A personal bless deed has been placed in your backpack.
                }
            }
        }
        #endregion
        ...
        public override bool CheckConflictingLayer(Mobile m, Item item, Layer layer)
        {
            ...
            else if (Layer == Layer.OneHanded && layer == Layer.TwoHanded && !(item is BaseShield) && !(item is BaseEquipableLight))
            {
               // m.SendLocalizedMessage(500215); // You can only wield one weapon at a time.
                m.SendAsciiMessage("You can only wield one weapon at a time.");
                return true;
            }
        ...
        public override bool CanEquip(Mobile from)
        {
            ...
            if (RequiredRace != null && from.Race != RequiredRace)
            {
                ...
                {
                    from.SendAsciiMessage("Only {0} may use this.", RequiredRace.PluralName);
                }
        ...
        public virtual bool CheckHit(Mobile attacker, Mobile defender)
        {
            ...
            BaseWeapon rngWeapon = defender.Weapon as BaseRanged;
		...
		public virtual int AbsorbDamageAOS(Mobile attacker, Mobile defender, int damage)
		{
			...
			if (defender.Player || defender.Body.IsHuman)
			{
				...
				if (blocked)
				{
					...
					if (Confidence.IsConfident(defender))
					{
                        ...
                        defender.SendAsciiMessage("Your confidence reassures you as you successfully block your opponent's nlow. ");
			...
			if (!blocked)
			{
				...
				if (armor != null)
				{
					...
					damage -= XmlAttach.OnArmorHit(attacker,
                        defender, armorItem, this, originalDamage);
				}
			}
			...
			if (MirrorImage.HasClone(defender) && (defender.Skills.Ninjitsu.Value / 150.0) > Utility.RandomDouble())
			{
				...
				foreach (Mobile m in defender.GetMobilesInRange(4))
				{
					...
					if (bc != null && bc.Summoned && bc.SummonMaster == defender)
					{
                        ...
                        defender.SendAsciiMessage("Your attack has been diverted to a nearby mirror image of your target! ");
                        attacker.SendAsciiMessage("You manage to divert the attack onto one of your nearby mirror images ");
				...
				if (Core.SA) // New formulas
				{
					if (lifeLeech != 0)
					{
						...
						if (defender is BaseCreature && ((BaseCreature)defender).TaintedLifeAura)
						{
                            ...
                            attacker.SendAsciiMessage("The tainted life force energy damages you as your body tries to absorb it. ");
                        }
						else
		...
		public virtual double ScaleDamageOld(Mobile attacker, double damage, bool checkSkills)
		{
            ...
            */
            ...
            ////divines 2.0 crits
            if (attacker is PlayerMobile && !(attacker.Combatant is PlayerMobile ))
            {
                PlayerMobile pm = (PlayerMobile)attacker;               
                if ((pm.CritChance) > Utility.Random(100) && damage > 0)
                {
		...
		public override void Serialize(GenericWriter writer)
		{
            ...
            //verson 16 dicedamage divines 2.0
...
/*
        ...
        */
        public override string BuildSingleClick()
        {
            ...
            else if (IsMagic && Name != null)
            {
                sb.Append("the magical, ");
            }
            ...
            if (Identified)
            {
                if (m_DamageLevel > WeaponDamageLevel.Regular)
                {
                   ...
                   //else if (m_DamageLevel == WeaponDamageLevel.Oblit)
                       // sb.Append("obliteration");
                    else
