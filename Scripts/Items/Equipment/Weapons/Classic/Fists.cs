                    ...
                    if (attacker.Skills[SkillName.Anatomy].Value >= 80.0 && attacker.Skills[SkillName.Wrestling].Value >= 80.0)
                    {
                        if (attacker.Stam >= 15)
                        {
                            ...
                            if (CheckMove(attacker, SkillName.Anatomy))
                            {
                                ...
                                attacker.SendAsciiMessage("you successfully stun your oponent.");
                                defender.SendAsciiMessage("you have been stunned.");
                            ...
                            else
                            {
                                ...
                                attacker.SendAsciiMessage("You failed to stun your oponent.");
                                defender.SendAsciiMessage("you have been stunned.");
                            }
                        }
                        else
                        {
                            ...
                            attacker.SendAsciiMessage("You are too fatigued to attempt anything.");
                        }
                    }
                    else
                    {
                        //attacker.SendLocalizedMessage(1004008); // You are not skilled enough to stun your opponent.
                        attacker.SendAsciiMessage("You are not sklled enough to stun your opponent.");
                        attacker.StunReady = false;
                    }
                }
            }
                    ...
                    if (defender.Player || defender.Body.IsHuman)
                    {
                        if (attacker.Skills[SkillName.ArmsLore].Value >= 80.0 && attacker.Skills[SkillName.Wrestling].Value >= 80.0)
                        {
                            if (attacker.Stam >= 15)
                            {
                                ...
                                {
                                    attacker.SendAsciiMessage("you cannot disarm your opponent.");// (1004001); // You cannot disarm your opponent.
                                }
                                else if (CheckMove(attacker, SkillName.ArmsLore))
                                {
                                    ...
                                    attacker.SendAsciiMessage("null."); //(1004006); // You successfully disarm your opponent!
                                    defender.SendAsciiMessage("null."); //(1004007); // You have been disarmed!
                                ...
                                else
                                {
                                    ...
                                    attacker.SendAsciiMessage("null.");// (1004004); // You failed in your attempt to disarm.
                                    defender.SendAsciiMessage("null.");// (1004005); // Your opponent tried to disarm you but failed.
                                }
                            }
                            else
                            {
                                attacker.SendAsciiMessage("null.");// (1004003); // You are too fatigued to attempt anything.
                            }
                        }
                        else
                        {
                            attacker.SendAsciiMessage("null.");// (1004002); // You are not skilled enough to disarm your opponent.
                            attacker.DisarmReady = false;
                        }
                    }
                    else
                    {
                        attacker.SendAsciiMessage("null.");// (1004001); // You cannot disarm your opponent.
                    }
                }
            }
        }
