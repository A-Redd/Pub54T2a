	...
	public class PoisonImpl : Poison
	{
		...
		public class PoisonTimer : Timer
		{
            ...
            protected override void OnTick()
            {
                ...
                {
                    m_Mobile.SendAsciiMessage("The poison seems to have worn off");
                ...
                if (Core.ML)
                {
                    ...
                    {
                        m_From.SendAsciiMessage("Darkglow poison increases your damage"); // Darkglow poison increases your damage!
                    ...
                    if (m_From != null && m_Mobile != m_From && m_From.InRange(m_Mobile.Location, 1) && m_Poison.m_Level >= 14 && m_Poison.m_Level <= 18) // parasitic
                    {
                        ...
                        if (toHeal > 0)
                        {
                            m_From.SendAsciiMessage("You have had {0} hitpoints of damage healed", toHeal.ToString()); // You have had ~1_HEALED_AMOUNT~ hit points of damage healed.
