...
namespace Server.Misc
{
    public class Titles
    {
        ...
        public static void AwardFame(Mobile m, int offset, bool message)
        {
            ...
            {
                if (offset > 40)
                    m.SendAsciiMessage("You have gained a lot of fame."); // You have gained a lot of karma.
                else if (offset > 20)
                    m.SendAsciiMessage("You have gained a good amount of fame."); // You have gained a good amount of karma.
                else if (offset > 10)
                    m.SendAsciiMessage("You have gained some fame."); // You have gained some karma.
                else if (offset > 0)
                    m.SendAsciiMessage("You have gained a little fame."); // You have gained a little karma.
                else if (offset < -40)
                    m.SendAsciiMessage("You have lost a lot of fame."); // You have lost a lot of karma.
                else if (offset < -20)
                    m.SendAsciiMessage("You have lost a good amount of fame."); // You have lost a good amount of karma.
                else if (offset < -10)
                    m.SendAsciiMessage("You have lost some fame."); // You have lost some karma.
                else if (offset < 0)
                    m.SendAsciiMessage("You have lost a little fame.."); // You have lost a little karma.
        ...
        public static void AwardKarma(Mobile m, int offset, bool message)
        {
            ...
            {
                if (offset > 40)
                    m.SendAsciiMessage("You have gained a lot of karma"); // You have gained a lot of karma.
                else if (offset > 20)
                    m.SendAsciiMessage("You have gained a good amount of karma."); // You have gained a good amount of karma.
                else if (offset > 10)
                    m.SendAsciiMessage("You have gained some karma."); // You have gained some karma.
                else if (offset > 0)
                    m.SendAsciiMessage("You have gained a little karma."); // You have gained a little karma.
                else if (offset < -40)
                    m.SendAsciiMessage("You have lost a lot of karma."); // You have lost a lot of karma.
                else if (offset < -20)
                    m.SendAsciiMessage("You have lost a good amount of karma."); // You have lost a good amount of karma.
                else if (offset < -10)
                    m.SendAsciiMessage("You have lost some karma."); // You have lost some karma.
                else if (offset < 0)
                    m.SendAsciiMessage("You have lost a little karma.."); // You have lost a little karma.
            }

            if (!Core.AOS && wasPositiveKarma && m.Karma < 0 && m is PlayerMobile && !((PlayerMobile)m).KarmaLocked)
            {
                ((PlayerMobile)m).KarmaLocked = false;
