...
namespace Server.Mobiles
{
	...
	public class PlayerMobile : Mobile, IHonorTarget
	{
        ...
        #region PlayerMobile Expansion
        public double m_CritChance;
        public double m_CritDamage;
        public double m_Toughness;
        public double m_DodgeChance;
        public double m_GoldBonus;
        public double m_LootBonus;
        ...
        public double DodgeChance
        {
            ...
            set { m_DodgeChance = value; }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public double GoldBonus
        {
            get { return m_GoldBonus; }
            set { m_GoldBonus = value; }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public double LootBonus
        {
            get { return m_LootBonus; }
            set { m_LootBonus = value; }
        }
        #endregion
		...
		*/
				...
				foreach (var kvp in m_RecoverableAmmo)
				{
					if (kvp.Value > 0)
					{
						...
						if (ammo != null)
						{
                            ...
                            SendAsciiMessage("You recover {0} {1}", ammo.Amount, name);
                        }
					}
				}
		...
		private void ValidateEquipment_Sandbox()
		{
			try
			{
				...
				for (int i = items.Count - 1; i >= 0; --i)
				{
					...
					if (item is BaseWeapon)
					{
						...
						if (drop)
						{
                            ...
                            from.SendAsciiMessage("You can no longer wield your {0} ", weapon);
					...
					else if (item is BaseArmor)
					{
						...
						if (drop)
						{
							...
							if (armor is BaseShield)
							{
                                ...
                                from.SendAsciiMessage("You can no longer wield your {0} ", name);
                            }
							else
							{
				...
				//	from.SendLocalizedMessage(500647); // Some equipment has been moved to your backpack.
                    from.SendAsciiMessage("some equipment has been moved to your backpack.");
                }
			}
			catch (Exception e)
			{
		...
		public override void OnSubItemAdded(Item item)
		{
			if (AccessLevel < AccessLevel.GameMaster && item.IsChildOf(Backpack))
			{
				...
				if (curWeight > maxWeight)
				{
                    ...
                    SendAsciiMessage("You are overloaded. Carrying: {0} / {1} stones", curWeight, maxWeight);
                }
			}
		}
			...
			if (ns != null)
			{
				if (HasGump(typeof(ResurrectGump)))
				{
					...
					else
					{
                        ...
                        SendAsciiMessage("You are frozen and cannot move.");
                        return false;
					}
				}
			}
			...
			if (AnimalForm.UnderTransformation(this))
			{
				for (int i = 0; i < m_AnimalFormRestrictedSkills.Length; i++)
				{
					if (m_AnimalFormRestrictedSkills[i] == skill)
					{
                        ...
                        SendAsciiMessage("You cannot use that skill in this form.");
                        return false;
					}
				}
			}
		...
		public virtual void RecheckTownProtection()
		{
			...
			if (isProtected != m_LastProtectedMessage)
			{
				if (isProtected)
				{
                    ...
                    SendAsciiMessage("You are now under the protection of the town guards.");
                }
				else
				{
					//SendLocalizedMessage(500113); // You have left the protection of the town guards.
                    SendAsciiMessage("You have left the protection of the town guards.");
                }
		...
		private void ToggleItemInsurance()
		{
            ...
            SendAsciiMessage("Target the item you wish to insure. <ESC> to cancel");
        }
		...
		public override bool CheckEquip(Item item)
		{
			...
			if (AccessLevel < AccessLevel.GameMaster && item.Layer != Layer.Mount && HasTrade)
			{
                ...
                SendAsciiMessage("You can only equip what you are already carrying while you have a trade pending.");
                return false;
			}
			...
			Mobile to, Item item, SecureTradeContainer cont, bool message, bool checkItems, int plusItems, int plusWeight)
		{
			...
			if (msgNum == 1154111)
			{
                ...
                SendAsciiMessage("{0} {1}.",msgNum,RawName);
            }
			else
			{
				//SendLocalizedMessage(msgNum);
                SendAsciiMessage("{0}.",msgNum);
            }
		...
		public override bool CheckNonlocalDrop(Mobile from, Item item, Item target)
		{
			...
			if (from == this && HasTrade && (target == pack || target.IsChildOf(pack)))
			{
                ...
                SendAsciiMessage("You van't do that while you have a trade pending..");
                return false;
			}
		...
		public override void OnDeath(Container c)
		{
			...
			//StolenItem.ReturnOnDeath(this, c); //divines 2.0
		...
		public override void DoSpeech(string text, int[] keywords, MessageType type, int hue)
		{
			if (Guilds.Guild.NewGuildSystem && (type == MessageType.Guild || type == MessageType.Alliance))
			{
				...
				if (g == null)
				{
                    ...
                    SendAsciiMessage("You are not in a guild!");
                }
				else if (type == MessageType.Alliance)
				{
					...
					else
					{
                        ...
                        SendAsciiMessage("You are not in an alliance!");
                    }
				}
		...
		public override void OnPoisonImmunity(Mobile from, Poison poison)
		{
			if (Young && (DuelContext == null || !DuelContext.Started || DuelContext.Finished))
			{
                ...
                SendAsciiMessage("null young poisoned.");
		...
		public override void Deserialize(GenericReader reader)
		{
                ...
                
			{
                ...
                case 32:
                    {
                        m_CritChance = reader.ReadDouble();
                        m_CritDamage = reader.ReadDouble();
                        m_Toughness = reader.ReadDouble();
                        m_DodgeChance = reader.ReadDouble();
                        m_GoldBonus = reader.ReadDouble();
                        m_LootBonus = reader.ReadDouble();
                        goto case 31;
                    }
		...
		public override void Serialize(GenericWriter writer)
		{
            ...
            //version 33 Player expansion

            writer.Write(m_CritChance);
            writer.Write(m_CritDamage);
            writer.Write(m_Toughness);
            writer.Write(m_DodgeChance);
            writer.Write(m_GoldBonus);
            writer.Write(m_LootBonus);
		...
		public void SelectCollectionTitle(int num, bool silent = false)
		{
			...
			{
				m_SelectedTitle = num;
                if (!silent) SendAsciiMessage("null.");//SendLocalizedMessage(1074010); // You elect to hide your Reward Title.
            ...
            else if (num < m_CollectionTitles.Count && num >= -1)
            {
                if (m_SelectedTitle != num)
                {
                    ...
                    {
                        SendAsciiMessage("null.");//SendLocalizedMessage(1074008, "#" + (int)m_CollectionTitles[num]);
                        // You change your Reward Title to "~1_TITLE~".	
                    }
                    else if (m_CollectionTitles[num] is string && !silent)
                    {
                        SendAsciiMessage("null."); //SendLocalizedMessage(1074008, (string)m_CollectionTitles[num]); // You change your Reward Title to "~1_TITLE~".	
                    }
                }
                else if (!silent)
                {
                    SendAsciiMessage("null."); //SendLocalizedMessage(1074009); // You decide to leave your title as it is.
                }
            }
		...
		public bool CheckYoungProtection(Mobile from)
		{
			...
			if (DateTime.UtcNow - m_LastYoungMessage > TimeSpan.FromMinutes(1.0))
			{
               ...
               SendAsciiMessage("null.");//SendLocalizedMessage(1019067);
		...
		public void ClaimAutoStabledPets()
		{
			...
			if (!Alive)
			{
                ...
                SendAsciiMessage("null pet claim.");
			...
			for (int i = m_AutoStabled.Count - 1; i >= 0; --i)
			{
				...
				else
				{
                    ...
                    SendAsciiMessage("{1} remained in the stables because you have too many followers." ,pet.Name);
                }
			}
