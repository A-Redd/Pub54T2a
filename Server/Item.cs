 ...
 */
        ...
        public virtual void OnSingleClick(Mobile from)
        {
            ...
            if (ns != null)
            {
                if (ForceClickLabelNumber && (Name == null || Name.Length <= 0)) //ascii
                {
                    if (DisplayLootType)
                        LabelLootTypeTo(from);//ascii
                    if (m_Amount <= 1)
                    {
